...
const AdminEditServiceItem = (props) => {
  ...
  const [description, changeDescription] = useState(props.item.description);
  ...
  const [
    updateService,
    { loading: updateServiceLoading, data: updateServiceData },
  ] = useMutation(updateServiceMutation);
  ...
  useEffect(() => {
    if (updateServiceData && !loadingSpinnerActive) {
      props.getAllServicesRefetch();
    }
  }, [
    updateServiceData,
  ...
  }, [updateServiceData, loadingSpinnerActive, dispatch]);

  const handleBackToAllService = () => {
    props.getAllServicesRefetch();
    props.changeAdminSelected("");
  };
          ...
          >
            ...
            <div className="admin_individual_selected_employee_contents">
              <div className="admin_individual_selected_client_back_container">
                ...
                />
                <p onClick={handleBackToAllService}>Back to the service</p>
              </div>
...
export default AdminEditServiceItem;
